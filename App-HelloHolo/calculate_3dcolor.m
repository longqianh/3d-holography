function pog=calculate_3dcolor(model,mcolor,z0,depth,slices,iter_num)
...
cut_pieces_color(model,mcolor,slices); 
[U0,xx0s,yy0s,xx,yy]=initialize_color(slices,M,N,L,pix); 
